...
SELECT DISTINCT nvl(manager_name, "unknown"), man_fam_name,man_mobile FROM fsdb.recordings
UNION
SELECT DISTINCT nvl(manager_name, "unknown"), man_fam_name,man_mobile FROM fsdb.livesingings;
